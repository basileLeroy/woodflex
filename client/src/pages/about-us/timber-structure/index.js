...
import banner from "../../../assets/images/timber-banner.jpg";
import image from "../../../assets/images/timber_image.jpg";
            ...
            <div className="component flex flex-col">
                <div className="bg-brown-sand w-full mt-16 px-3 lg:flex content-center">
                    <div className="text-white w-full py-4 lg:py-0 lg:w-2/3 my-auto relative">
                        <img src={image} alt="" />
                        <h1 className="text-6xl font-bold text-center absolute inset-0 top-1/3">Timber.</h1>
                    </div>
